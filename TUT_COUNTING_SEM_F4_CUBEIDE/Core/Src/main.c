...
void HPT_TASK (void *pcParameters);

TaskHandle_t MPThandler;
void MPT_TASK (void *pcParameters);

TaskHandle_t LPThandler;
void LPT_TASK (void *pcParameters);

TaskHandle_t VLPThandler;
void VLPT_TASK (void *pcParameters);
...
int main(void)
{
  ...
  else HAL_UART_Transmit(&huart2, (uint8_t *) "Counting Semaphore created sccessfully\n\n", 41, 1000);
